...
from .serializers import ProfileSerializer, EventSerializer, RelationshipTypeSerializer, PhotoSerializer, ContactSerializer, RelationshipSerializer, MapContactEventSerializer
...
class ContactListCreate(generics.ListCreateAPIView):
    ...
    def post(self, request, pk, format=None):
        ...
        if profile.user == request.user:
            ...
            return Response({"error": "You can only create contacts under your own profile."},
